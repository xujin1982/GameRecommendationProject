...
if __name__ == '__main__':
	...
	# Load steam_user_id
	steam_user_id = []
	with open('../output/2016-12-27_steam_id_full.txt','r') as f:
		for steamid in f.readlines():
			steam_user_id.append(steamid.strip())


	# Define variables
	output_file = '../output/%s_user_inventory_full.json' % (datetime.today().isoformat()[:10])
	...
	steam_user_id = set(steam_user_id)
